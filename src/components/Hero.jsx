      ...
      <div className="max-w-[1450px] mx-auto px-6 sm:px-10 lg:px-16 w-full">
        <div className="font-Cinzel max-w-3xl  " style={{textShadow: "4px 4px 12px rgba(0,0,0,0.8)"}}>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            ...
            <button className="px-8 py-4 rounded-full border border-white/40 bg-white/10 backdrop-blur-md text-white hover:bg-white hover:text-black transition duration-300">
              Explore Rooms
            </button>
          </div>
